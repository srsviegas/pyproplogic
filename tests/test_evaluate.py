...
def test_evaluate_complex_formulas():
    formula1 = ((P & Q) | R) >> (S << ~T)
    assert formula1.evaluate({'P': True, 'Q': False, 'R': True, 'S': False, 'T': True}) == True
    assert formula1.evaluate({'P': False, 'Q': True, 'R': False, 'S': True, 'T': False}) == True
    assert formula1.evaluate({'P': True, 'Q': True, 'R': False, 'S': True, 'T': False}) == True

    formula2 = ~(P & (Q | R)) | (S & T)
    assert formula2.evaluate({'P': True, 'Q': True, 'R': False, 'S': False, 'T': True}) == False
    assert formula2.evaluate({'P': False, 'Q': False, 'R': True, 'S': True, 'T': False}) == True
    assert formula2.evaluate({'P': True, 'Q': False, 'R': True, 'S': True, 'T': False}) == False
    ...
    assert formula4.evaluate({'P': True, 'Q': True, 'R': True, 'S': True, 'T': True}) == True
    assert formula4.evaluate({'P': False, 'Q': True, 'R': False, 'S': True, 'T': False}) == False
    assert formula4.evaluate({'P': True, 'Q': False, 'R': True, 'S': False, 'T': True}) == True